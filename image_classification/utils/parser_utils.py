...
def get_args():
    ...
    parser.add_argument('--p_lr', type=float, default=0.00001, help='Learning rate for p in TR-MAML')
    parser.add_argument('--TR_MAML', type=str, default="False", help='Whether to use TR-MAML')
