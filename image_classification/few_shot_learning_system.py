...
class MAMLFewShotClassifier(nn.Module):
    ...
    def forward(self, data_batch, epoch, use_second_order, use_multi_step_loss_optimization, num_steps, training_phase):
        ...
        return losses, total_losses, total_accuracies, per_task_target_preds
    ...
    def train_forward_prop(self, data_batch, epoch):
        ...
        """
        losses, full_losses, full_accs, per_task_target_preds = self.forward(data_batch=data_batch, epoch=epoch,
    ...
    def evaluation_forward_prop(self, data_batch, epoch):
        ...
        :return: A dictionary of losses for the current step.
        """  
        losses, _, full_accs, per_task_target_preds = self.forward(data_batch=data_batch, epoch=epoch, use_second_order=False,
